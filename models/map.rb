...
class Map
  ...
  def self.make_link(location, postcode)
    ...
    iframe_html = "<iframe width='400' height='450' frameborder='0' style='border:0' src='https://www.google.com/maps/embed/v1/place?key=#{API_KEY}&q=#{@location_string}' allowfullscreen></iframe>"
    return iframe_html
  end
